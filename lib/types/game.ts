...
export type GameMode = "race" | "arcade"
...
export type ClientEvent =
  | { type: "join_room"; token: string; username: string; avatar: string }
  | { type: "leave_room" }
...
> = {
  ...
  wpm_50: {
    name: "Speed Typist",
    description: "Reach 50 WPM in any game",
    icon: "⚡",
  },
  wpm_75: {
    name: "Fast Fingers",
    description: "Reach 75 WPM in any game",
    icon: "🔥",
  },
  wpm_100: {
    name: "Century",
    description: "Reach 100 WPM in any game",
    icon: "💯",
  },
  wpm_120: {
    name: "Blazing",
    description: "Reach 120 WPM in any game",
    icon: "🚀",
  },
  sharpshooter: {
    name: "Sharpshooter",
